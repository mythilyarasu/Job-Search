    ...
    <div className='footer p-[5rem] mb-4 bg-blueColor rounded-[10px] gap-8 grid grid-cols-5 m-auto items-center justify-center' >
      <div>
        <div className="logoDiv">
            <h1 className="logo text-[25px] text-white p-[1.5rem]">
              <strong>Job</strong>Search
            </h1>
        </div>
        <p className='text-white  pb-[13px] opacity-70 leading-7'>
          The best time for a new beginning is now! Find your Dream Job!!
        </p>
      </div>
      ...
      <div className='grid '>
        ...
        <div className='grid gap-3'>
          ...
          <li className='text-white opacity-[0.7] hover:opacity-[1] '>Blogs</li>
